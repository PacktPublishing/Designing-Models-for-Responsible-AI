'''
In this example we learn about how we can leverage the real-time nature of the learning process to allow an adversary to train a
Generative Adversarial Network (GAN) that generates prototypical samples of the targeted training set.
The attack is planned on the samples generated by the GAN, having the same distribution as the training data.
'''
