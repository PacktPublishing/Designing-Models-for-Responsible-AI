...
It shows how to use CodeCarbon to compute the emissions in the overall training process that
is involved with hyper-parameter training with randomized search method. The tracker starts computing the Co2 emissions
during start of the tuning process and logs down the overall CO2 emitted.
"""
