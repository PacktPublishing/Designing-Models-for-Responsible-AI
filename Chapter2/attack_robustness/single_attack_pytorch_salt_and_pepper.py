#!/usr/bin/env python3
"""
In this example we learn about how to run a single Salt and Pepper noise attack against
 a PyTorch ResNet-18 model for different epsilons and how to then report
the robust accuracy. Salt and Pepper Noise adds impuslse noise that leads to
sharp and sudden disturbances in the input image ultimately leading to misclassification

"""
import torchvision.models as models
import eagerpy as ep
from foolbox import PyTorchModel, accuracy, samples
from foolbox.attacks import LinfPGD, SaltAndPepperNoiseAttack
