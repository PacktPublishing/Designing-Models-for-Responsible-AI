#!/usr/bin/env python3
"""
In this example we learn about a very special attack called Spatial attack as it tries to find adversarial
perturbations using a set of translations and rotations rather then in an Lp ball.
It therefore done using a slightly different interface. Here we evaluate the attack success and the robustness accuracy
"""
...
def main() -> None:
    ...
    preprocessing = dict(mean=[0.285, 0.356, 0.416], std=[0.219, 0.204, 0.125], axis=-3)
